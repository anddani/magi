use crate::{
    git::checkout::{CheckoutResult, checkout_new_branch},
    model::{Model, popup::PopupContent},
    msg::Message,
};

pub fn update(model: &mut Model, starting_point: String, branch_name: String) -> Option<Message> {
    ...
    match checkout_new_branch(repo_path, &branch_name, &starting_point) {
