...
pub fn is_external_command(msg: &Message) -> bool {
    match msg {
        ...
        | Message::ShowFetchAnotherBranchSelect
        | Message::ShowFetchAnotherBranchBranchSelect(_)
        | Message::FetchFromRemote(_)
        | Message::ShowFetchPushRemoteSelect
        | Message::FetchFromPushRemote(_)
        ...
        | Message::ShowPullPushRemoteSelect
        | Message::PullFromPushRemote(_)
        | Message::ShowPushPushRemoteSelect
        | Message::PushToPushRemote(_)
