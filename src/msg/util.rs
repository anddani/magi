...
use crate::{
    ...
    msg::{FixupType, MergeCommand, Message, RebaseCommand, RevertCommand},
};
...
pub fn is_external_command(msg: &Message) -> bool {
    matches!(
        ...
        Message::Commit
            ...
            | Message::Rebase(RebaseCommand::RemoveCommit(_))
            | Message::Rebase(RebaseCommand::Autosquash(_))
            | Message::Rebase(RebaseCommand::AutosquashInto(_))
