...
pub struct Strings {
    ...
    pub input_worktree_move_path_fmt: &'static str,
    ...
    pub input_stash_branch_here_fmt: &'static str,
    ...
    /// Window title while picking a commit to modify (edit in a rebase)
    ...
    pub cmd_move_worktree: &'static str,
    pub cmd_delete_worktree: &'static str,
    pub cmd_visit_worktree: &'static str,
    ...
    pub cmd_branch_here: &'static str,
    pub cmd_format_patch: &'static str,
    ...
    pub cmd_merge_edit_message: &'static str,
    pub cmd_merge_no_commit: &'static str,
    ...
    pub cmd_spinout: &'static str,
    pub input_cherry_spinout: &'static str,
    pub cmd_spinoff: &'static str,
    pub input_cherry_spinoff: &'static str,
    ...
    // Argument descriptions shown in popup argument columns
    pub arg_commit_stage_all: &'static str,
    pub arg_commit_allow_empty: &'static str,
    pub arg_commit_verbose: &'static str,
    pub arg_commit_disable_hooks: &'static str,
    pub arg_commit_reset_author: &'static str,
    pub arg_commit_gpg_sign: &'static str,
    pub arg_commit_author: &'static str,
    pub arg_commit_reuse_message: &'static str,
    pub select_commit_reuse_message: &'static str,
    pub arg_fetch_prune: &'static str,
    pub arg_fetch_tags: &'static str,
    pub arg_fetch_force: &'static str,
    pub arg_push_force_with_lease: &'static str,
    pub arg_push_force: &'static str,
    pub arg_push_disable_hooks: &'static str,
    pub arg_push_dry_run: &'static str,
    pub arg_push_set_upstream: &'static str,
    pub arg_push_include_all_tags: &'static str,
    pub arg_push_include_related_tags: &'static str,
    pub arg_pull_ff_only: &'static str,
    pub arg_pull_rebase: &'static str,
    pub arg_pull_autostash: &'static str,
    pub arg_pull_force: &'static str,
    pub arg_stash_include_untracked: &'static str,
    pub arg_stash_all: &'static str,
    /// Shown when no push-remote is configured: "${push-remote}, setting it"
    ...
    pub arg_revert_gpg_sign: &'static str,
    pub select_revert_gpg_sign: &'static str,
...
static ENGLISH: Strings = Strings {
    ...
    input_first_release_tag: "Create first release tag",
    ...
    input_stash_keeping_index_message: "Stash keeping index message",
    input_rename_branch_fmt: "Rename branch '{}' to:",
    input_worktree_path_fmt: "Worktree path for '{}'",
    input_worktree_move_path_fmt: "Move worktree '{}' to",
    ...
    input_stash_branch_here_fmt: "Name for new branch here, then apply {}",
    ...
    cmd_move_worktree: "Move worktree",
    cmd_delete_worktree: "Delete worktree",
    cmd_visit_worktree: "Visit worktree",
    ...
    cmd_branch: "Branch",
    cmd_branch_here: "Branch here",
    cmd_format_patch: "Format patch",
    cmd_file: "File",
    ...
    cmd_abort: "Abort",
    cmd_merge: "Merge",
    cmd_merge_edit_message: "Merge and edit message",
    cmd_merge_no_commit: "Merge but don't commit",
    ...
    cmd_donate: "Donate",
    cmd_spinout: "Spinout",
    input_cherry_spinout: "Spin out to new branch",
    cmd_spinoff: "Spinoff",
    input_cherry_spinoff: "Spin off to new branch",
    cmd_fetch: "Fetch",
    cmd_log: "Log",
    cmd_pull: "Pull",
    cmd_push: "Push",
    ...
    arg_commit_stage_all: "Stage all modified and deleted files",
    arg_commit_allow_empty: "Allow empty commit",
    arg_commit_verbose: "Show diff of changes to be commited",
    arg_commit_disable_hooks: "Disable hooks",
    arg_commit_reset_author: "Claim authorship and reset author date",
    arg_commit_gpg_sign: "Sign using gpg",
    arg_commit_author: "Override the author",
    arg_commit_reuse_message: "Reuse commit message",
    select_commit_reuse_message: "Reuse message from commit",
    arg_fetch_prune: "Prune deleted branches",
    arg_fetch_tags: "Fetch all tags",
    arg_fetch_force: "Force",
    arg_push_force_with_lease: "Force with lease",
    arg_push_force: "Force",
    arg_push_disable_hooks: "Disable hooks",
    arg_push_dry_run: "Dry run",
    arg_push_set_upstream: "Set upstream",
    arg_push_include_all_tags: "Include all tags",
    arg_push_include_related_tags: "Include related annotated tags",
    arg_pull_ff_only: "Fast-forward only",
    arg_pull_rebase: "Rebase local commits",
    arg_pull_autostash: "Autostash",
    arg_pull_force: "Force",
    arg_stash_include_untracked: "Also save untracked files",
    ...
    arg_revert_edit: "Edit commit message",
    arg_revert_no_edit: "Don't edit commit message",
    arg_log_graph: "Show graph",
    arg_log_color: "Show graph in color",
    arg_log_decorate: "Show refnames",
    arg_log_show_header: "Show header",
    arg_log_patch: "Show diffs",
    arg_log_show_signature: "Show signatures",
    arg_tag_force: "Force",
    arg_tag_edit: "Edit message",
    arg_tag_annotate: "Annotate",
    arg_tag_sign: "Sign",
    arg_tag_sign_as: "Sign as",
    ...
    arg_revert_gpg_sign: "Sign using gpg",
    select_revert_gpg_sign: "Sign with key",
...
static SWEDISH: Strings = Strings {
    ...
    input_first_release_tag: "Skapa första utgåvomärket",
    ...
    input_worktree_move_path_fmt: "Flytta arbetsträd '{}' till",
    ...
    input_stash_branch_here_fmt: "Namnge ny gren här, applicera sedan {}",
    help_version_fmt: "Magi version {}",
    ...
    cmd_move_worktree: "Flytta arbetsträd",
    cmd_delete_worktree: "Ta bort arbetsträd",
    cmd_visit_worktree: "Besök arbetsträd",
    ...
    cmd_branch: "Gren",
    cmd_branch_here: "Gren här",
    cmd_format_patch: "Formatera patch",
    cmd_file: "Fil",
    ...
    cmd_merge_edit_message: "Sammanfoga och redigera meddelande",
    cmd_merge_no_commit: "Sammanfoga men checka inte in",
    ...
    cmd_donate: "Donera",
    cmd_spinout: "Spin ut",
    input_cherry_spinout: "Spin ut till ny gren",
    cmd_spinoff: "Spin av",
    input_cherry_spinoff: "Spin av till ny gren",
    cmd_fetch: "Hämta",
    cmd_log: "Diarium",
    cmd_pull: "Rycka",
    cmd_push: "Knuffa",
    ...
    arg_commit_stage_all: "Klarmarkera alla ändrade och fimpade filer",
    arg_commit_allow_empty: "Tillåt tom förbindelse",
    arg_commit_verbose: "Visa skillnad av ändringar att förbinda",
    arg_commit_disable_hooks: "Inaktivera krokar",
    arg_commit_reset_author: "Hävda upphovsrätt och återställ upphovsdatum",
    arg_commit_gpg_sign: "Signera med gpg",
    arg_commit_author: "Åsidosätt upphovsmannen",
    arg_commit_reuse_message: "Återanvänd förbindelsemeddelande",
    select_commit_reuse_message: "Återanvänd meddelande från förbindelse",
    arg_fetch_prune: "Beskär raderade grenar",
    arg_fetch_tags: "Hämta alla märken",
    arg_fetch_force: "Tvinga",
    arg_push_force_with_lease: "Tvinga med förbehåll",
    arg_push_force: "Tvinga",
    arg_push_disable_hooks: "Inaktivera krokar",
    arg_push_dry_run: "Torrkörning",
    arg_push_set_upstream: "Sätt uppströmsgren",
    arg_push_include_all_tags: "Inkludera alla märken",
    arg_push_include_related_tags: "Inkludera relaterade annoterade märken",
    arg_pull_ff_only: "Endast snabbspola",
    arg_pull_rebase: "Ympa lokala förbindelser",
    arg_pull_autostash: "Automatgömma",
    arg_pull_force: "Tvinga",
    arg_stash_include_untracked: "Spara även ospårade filer",
    ...
    arg_revert_gpg_sign: "Signera med gpg",
    select_revert_gpg_sign: "Signera med nyckel",
