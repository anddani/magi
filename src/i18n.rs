...
static SWEDISH: Strings = Strings {
    ...
    section_unstaged_changes: "Ej iscensatta ändringar",
    section_staged_changes: "Iscensatta ändringar",
    section_recent_commits: "Senaste incheckningar",
    section_stashes: "Tillfälliga ändringar",
    section_rebasing: "Ombaserar",
    section_reverting: "Återgår",
    section_cherry_picking: "Plockar",
    section_unpulled_from_prefix: "Ej hämtade från ",

    popup_branch: "Gren",
    popup_commit: "Incheckning",
    popup_push: "Skicka",
    popup_pull: "Hämta",
    popup_fetch: "Hämta ned",
    popup_log: "Logg",
    popup_stash: "Göm",
    popup_tag: "Tagg",
    popup_reset: "Återställ",
    popup_rebase: "Ombasera",
    popup_revert: "Återgå",
    popup_merge: "Sammanfoga",
    popup_merging: "Sammanfogar",
    popup_apply: "Applicera",
    popup_applying: "Applicerar",
    popup_help: "Hjälp",
    popup_error: "Fel",
    ...
    col_fetch_from: "Hämta ned från",
    col_actions: "Åtgärder",
    col_commands: "Kommandon",
    col_applying_changes: "Tillämpa ändringar",
    col_general: "Allmänt",
    col_apply_here: "Applicera här",

    push_to_pre: "Skicka ",
    push_to_post: " till",
    push_to_fallback: "Skicka till",
    pull_into_pre: "Hämta till ",
    pull_into_post: " från",
    pull_into_fallback: "Hämta till",
    rebase_onto_pre: "Ombasera ",
    rebase_onto_post: " på",

    input_new_branch: "Namn för ny gren",
    input_spinoff_branch: "Namn för ny spin-off-gren",
    input_spinout_branch: "Namn för ny spin-out-gren",
    input_tag_name: "Taggnamn",
    input_stash_message: "Göm meddelande",
    ...
    input_push_refspec_fmt: "Skicka refspec(er) till '{}' (kommaseparerade)",
    ...
    cmd_new_pr_default: "ny PR till standardgren",
    cmd_new_pr_to: "ny PR till...",
    cmd_new_spinout: "ny spin-out",
    cmd_rename: "byt namn",
    cmd_delete: "ta bort",
    cmd_reset: "återställ",
    cmd_commit: "incheckning",
    cmd_extend: "förläng",
    cmd_amend: "ändra",
    ...
    cmd_push_tag: "skicka en tagg",
    cmd_push_all_tags: "skicka alla taggar",
    cmd_branch: "gren",
    cmd_file: "fil",
    cmd_reset_mixed: "blandat  (HEAD och index)",
    cmd_reset_soft: "mjukt    (endast HEAD)",
    cmd_reset_hard: "hårt     (HEAD, index och arbetsträd)",
    cmd_reset_keep: "behåll   (HEAD och index, behåll icke-incheckade)",
    cmd_reset_index: "index    (endast)",
    cmd_reset_worktree: "arbetsträd (endast)",
    cmd_continue: "fortsätt",
    cmd_skip: "hoppa över",
    cmd_abort: "avbryt",
    cmd_merge: "sammanfoga",
    cmd_revert_commits: "Återgå commit(s)",
    cmd_pick: "välj",
    cmd_fetch: "hämta ned",
    cmd_log: "logg",
    cmd_pull: "hämta",
    ...
    cmd_stash: "göm",
    cmd_stage: "preparera",
    cmd_stage_all: "preparera allt",
    cmd_unstage: "avpreparera",
    cmd_unstage_all: "avpreparera allt",
    cmd_discard: "förkasta",
    cmd_quit: "        avsluta",
    cmd_refresh: "uppdatera",
    ...
    cmd_scroll_down: "   scrolla en rad ned",
    cmd_scroll_up: "   scrolla en rad upp",
    cmd_toggle_section: "      växla ihopfällt/utfällt",
    cmd_visual_mode: "        aktivera visuellt urläge",
